//
//  ChineseDe-SKY-ViewController.swift
//  SwiftSideslipLikeQQ
//
//  Created by jessicafu on 2017/7/18.
//  Copyright © 2017年 com.lvwenhan. All rights reserved.
//

import UIKit

class ChineseDe_SKY_ViewController: UIViewController , UIImagePickerControllerDelegate , UINavigationControllerDelegate{
    var tablecell : Int!
    var gifView = GIFView()
    var TapTarget = " "   //点击传值
    var ChineseDeTarget = ""
    override func viewDidLoad() {
        ...
        jgwCHineseView_bgView.frame = CGRect(x: ChineseDeLable.frame.origin.x-10, y:ChineseDeLable.frame.origin.y-7, width: ChineseDeLable.frame.width+20, height:ChineseDeLable.frame.height+14  )
        ...
        cameraBtn.frame = CGRect(x: deviceWidth-20-44, y:englishLable.frame.origin.y+englishLable.frame.height-40, width: 44, height: 40)
...
extension ChineseDeViewController : CAAnimationDelegate {
